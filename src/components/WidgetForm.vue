                    ...
                    <template v-if="element.type == 'grid'">
                        <div v-if="element && element.key" class="widget-grid-container data-grid" :key="element.key"
                            ...
                            <el-button title="删除" style="bottom: -20px;" @click.stop="handleWidgetDelete(index)"
                                       class="widget-action-delete" v-if="selectWidget.key == element.key" circle plain
                                       type="danger">
             ...
             //   console.log('end', evt)
                ...
                this.$set(this.data.list, newIndex, {
                    ...
                    options: {
                        ...
                        remoteFunc: this.data.list[newIndex].options.remoteFunc?(this.data.list[newIndex].options.remoteFunc==''?'func_' + key:this.data.list[newIndex].options.remoteFunc):null,

                        props:{
                            ...this.data.list[newIndex].options.props,
                            id:null,
                           // ...this.data.list[newIndex].options.props.id,

                        }
                        // remoteFunc: 'genRemoteFuncDataBySelect'
                    },
                    key,
                    // 绑定键值
            ...
            handleWidgetColAdd($event, row, colIndex) {
                ...
                this.$set(row.columns[colIndex].list, newIndex, {
                    ...
                    options: {
                        ...
                        remoteFunc: row.columns[colIndex].list[newIndex].options.remoteFunc?(row.columns[colIndex].list[newIndex].options.remoteFunc==''?'func_' + key:row.columns[colIndex].list[newIndex].options.remoteFunc):null,

                        props:{
                            ...row.columns[colIndex].list[newIndex].options.props,
                            id:null,
